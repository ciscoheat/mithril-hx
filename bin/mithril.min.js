Mithril = m = new function app(window, undefined) {
	...
	function compareNodes(a, b, maxDepth) {
		if (a.tag != b.tag || 
		...
		for(var i = 0; i < a.children.length; i++)
			if(!compareNodes(a.children[i], b.children[i], maxDepth-1)) return false;
